...
LIBDIRS		:= $(BLOCKSDS)/libs/libnds $(BLOCKSDS)/libs/dswifi $(BLOCKSDSEXT)/nflib $(BLOCKSDSEXT)/libdsf
...
CXXFLAGS	+= -g -std=gnu++17 $(WARNFLAGS) $(DEFINES) $(ARCH) \
		   -mthumb -mthumb-interwork $(INCLUDEFLAGS) -O2 \
		   -ffunction-sections -fdata-sections \
